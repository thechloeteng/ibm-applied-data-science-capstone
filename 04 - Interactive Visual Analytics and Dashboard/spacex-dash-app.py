...
#Get the launch sites from the spacex_df dataframe to use in TASK 1's dropdown list
launch_sites = []
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'All Sites':
        ...
        # Return the outcomes pie chart for a selected launch site
...
@app.callback(Output(component_id='success-payload-scatter-chart', component_property='figure'),
            [Input(component_id='site-dropdown', component_property='value'), Input(component_id='payload-slider', component_property='value')]) # IMPORTANT: there are 2 inputs SO they are put in a list
...
def get_scatter_chart(entered_site, payload_slider):
    ...
    if entered_site == 'All Sites':
        ...
        return fig
    # ELSE when a specific site is selected, filter the spacex_df dataframe first THEN render a scatter plot to display the same as for All Sites
    else:
